...
- **Stack**: React + TypeScript + Vite for ProjectM; also supports web, mobile, and dashboard UI work
...
### Step 4: Stack Guidelines (React / Web)
...
```bash
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react
```
