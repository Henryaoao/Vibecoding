...
定义 `finance-light-news` 模块在移动端 App 中的独立员工门户行为，使 App 能基于后端合同交付 财经轻资讯 的移动端体验。
...
1. App 提供移动端财经资讯列表、详情、分类/标签和醒目的非投资建议提示。
...
- App 需求能支持 阅读已发布财经资讯、查看分类/标签和明确的非投资建议提示。
