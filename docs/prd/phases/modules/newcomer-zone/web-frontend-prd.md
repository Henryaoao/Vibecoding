...
定义 `newcomer-zone` 模块在 Web 员工门户和 Web Admin Console 中的浏览器端行为，使 Web 能在不重写后端合同的前提下交付 新人专区 能力。
...
- 后端 PRD：`docs/prd/phases/modules/newcomer-zone/backend-prd.md`。
...
1. Web 员工端提供新人资料、任务列表和个人任务状态更新；Web Admin Console 提供新人内容与任务模板管理。
...
- Web 员工端能力能支持 查看新人资料、完成个人入职任务、跟踪自己的任务状态。
- Web Admin Console 能支持 维护入职资料、任务模板、排序、有效期和面向新人群体的内容状态。
