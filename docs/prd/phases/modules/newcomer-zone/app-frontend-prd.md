...
定义 `newcomer-zone` 模块在移动端 App 中的独立员工门户行为，使 App 能基于后端合同交付 新人专区 的移动端体验。
...
1. App 提供移动端新人资料、任务清单和仅限本人任务的状态更新。
...
- App 需求能支持 查看新人资料、完成个人入职任务、跟踪自己的任务状态。
