# ProjectM 模块 PRD：员工论坛热帖 App 前端层
...
定义 `forum-hot-posts` 模块在移动端 App 中的独立员工门户行为，使 App 能基于后端合同交付 员工论坛热帖 的移动端体验。
...
1. App 提供移动端热帖流、详情、评论摘要和被允许的轻量互动。
...
- App 需求能支持 查看热帖、详情、评论摘要，并在后端允许的范围内参与轻量互动。
