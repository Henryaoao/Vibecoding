...
定义 `training-center` 模块在 Web 员工门户和 Web Admin Console 中的浏览器端行为，使 Web 能在不重写后端合同的前提下交付 培训中心 能力。
...
- 后端 PRD：`docs/prd/phases/modules/training-center/backend-prd.md`。
...
1. Web 员工端提供课程列表、详情、材料和个人进度更新；Web Admin Console 提供培训内容管理。
...
- Web 员工端能力能支持 浏览课程、查看材料、更新自己的学习进度。
- Web Admin Console 能支持 创建、编辑、发布、归档、下线课程，并维护课程材料和排序。
